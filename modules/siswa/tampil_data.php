...
<div class="row">
    ...
    */
    ...
    // sql statement untuk menampilkan data dari tabel "tbl_siswa" dan tabel "tbl_kelas"
    $query = mysqli_query($mysqli, "SELECT a.id_siswa, a.kelas, a.nama_lengkap, a.foto_profil, b.nama_kelas 
                                    FROM tbl_siswa as a INNER JOIN tbl_kelas as b ON a.kelas=b.id_kelas
                                    ORDER BY a.id_siswa DESC LIMIT $batas_awal, $batas")
    ...
    if ($rows <> 0) {
        ...
        <div class="d-flex flex-column flex-xl-row align-items-center mt-4">
            ...
            <div class="flex-grow-1 text-center text-xl-start text-muted mb-3">
                ...
                $query = mysqli_query($mysqli, "SELECT id_siswa FROM tbl_siswa")
                ...
                */
                ...
                $query = mysqli_query($mysqli, "SELECT id_siswa FROM tbl_siswa LIMIT $data_awal, $batas")
            ...
            <ul class="pagination justify-content-center">
                ...
                // jika paginasi halaman > 1, maka button link "<" aktif
                    ...
                    <li class="page-item pagination-pill">
                        <a class="page-link" href="?module=siswa&paginasi=<?php echo $paginasi_halaman - 1; ?>" aria-label="Previous">
                            <i class="fa-solid fa-angle-left"></i>
                        </a>
                    </li>
                <?php } ?>
                ...
                */
                ...
                ?>
                    <li class="page-item pagination-pill <?php echo $link_active; ?>">
                        <a class="page-link" href="?module=siswa&paginasi=<?php echo $x; ?>"><?php echo $x; ?></a>
                    </li>
                <?php } ?>
                ...
                // jika "paginasi_halaman" < "jumlah_paginasi_halaman", maka button link ">" aktif
                    ...
                    <li class="page-item pagination-pill">
                        <a class="page-link" href="?module=siswa&paginasi=<?php echo $paginasi_halaman + 1; ?>" aria-label="Next">
                            <i class="fa-solid fa-angle-right"></i>
                        </a>
                    </li>
                <?php } ?>
