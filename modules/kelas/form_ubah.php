...
<div class="bg-white rounded-4 shadow-sm p-4 mb-4">
    ...
    <div class="alert alert-secondary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Ubah Data Kelas
    </div>
    <!-- form ubah data -->
    <form action="modules/kelas/proses_ubah.php" method="post" class="needs-validation" novalidate>
        <div class="row">
            <input type="hidden" name="id_kelas" value="<?php echo $data['id_kelas']; ?>">

            <div class="mb-3">
                <label class="form-label">Nama Kelas <span class="text-danger">*</span></label>
                <input type="text" name="nama_kelas" class="form-control" autocomplete="off" value="<?php echo $data['nama_kelas']; ?>" required>
        ...
        <div class="pt-4 pb-2 mt-5 border-top">
            <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                ...
                <a href="?module=tampil_detail_kelas&id=<?php echo $data['id_kelas']; ?>" class="btn btn-outline-secondary px-4">Batal</a>
            </div>
        </div>
    </form>
</div>