...
<div class="mb-5">
    <div class="row flex-lg-row-reverse align-items-center">
        ...
        <div class="col-lg-5 col-xl-3">
            <a href="?module=form_entri_kelas" class="btn btn-outline-brand float-lg-end px-4 mb-4 mb-lg-0">
                <i class="fa-solid fa-plus me-2"></i> Entri Kelas
            </a>
        </div>
        <!-- form pencarian -->
...
if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fa-solid fa-circle-check me-2"></i>Sukses!</strong> Data kelas berhasil disimpan.
    ...
    elseif ($_GET['pesan'] == 2) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fa-solid fa-circle-check me-2"></i>Sukses!</strong> Data kelas berhasil dihapus.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>';
    }
}
...
<div class="row">
    ...
    */
    ...
    $query = mysqli_query($mysqli, "SELECT id_kelas, nama_kelas FROM tbl_kelas 
                                    ORDER BY id_kelas DESC LIMIT $batas_awal, $batas")
    ...
    if ($rows <> 0) {
        ...
        <div class="d-flex flex-column flex-xl-row align-items-center mt-4">
            ...
            <div class="flex-grow-1 text-center text-xl-start text-muted mb-3">
                <?php
                // sql statement untuk menampilkan jumlah data pada tabel "tbl_kelas"
                $query = mysqli_query($mysqli, "SELECT id_kelas FROM tbl_kelas")
                ...
                */
                ...
                // sql statement untuk menampilkan jumlah data pada tabel "tbl_kelas" yang ditampilkan per halaman
                $query = mysqli_query($mysqli, "SELECT id_kelas FROM tbl_kelas LIMIT $data_awal, $batas")
            ...
            <ul class="pagination justify-content-center">
                ...
                // jika paginasi halaman > 1, maka button link "<" aktif
                    ...
                    <li class="page-item pagination-pill">
                        <a class="page-link" href="?module=kelas&paginasi=<?php echo $paginasi_halaman - 1; ?>" aria-label="Previous">
                            <i class="fa-solid fa-angle-left"></i>
                        </a>
                    </li>
                <?php } ?>
                ...
                */
                ...
                ?>
                    <li class="page-item pagination-pill <?php echo $link_active; ?>">
                        <a class="page-link" href="?module=kelas&paginasi=<?php echo $x; ?>"><?php echo $x; ?></a>
                    </li>
                <?php } ?>
