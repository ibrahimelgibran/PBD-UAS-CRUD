...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    <div class="row align-items-center justify-content-between">
        <div class="col-lg-3 d-block mt-xxl-n4">
            <img class="img-fluid px-xl-4 mt-xxl-n5" src="assets/img/bg-dashboard.png">
        </div>
        <div class="col-lg-9">
            <h4 class="mt-3 mt-lg-0 mb-2">Selamat datang di <strong>IegCode</strong>!</h4>
            <p class="text-muted fw-light mb-4">IegCode merupakan platform belajar koding online yang akan membantu mengembangkan skill koding Kamu dengan belajar melalui beragam studi kasus pembuatan aplikasi yang dapat dipraktekan secara langsung.</p>
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                <a href="https://ibrahimelgibran.com/#portfolio" target="_blank" class="btn btn-outline-brand">Lihat Project <i class="fa-solid fa-angle-right ms-3"></i></a>
            </div>
        </div>
    </div>
</div>
